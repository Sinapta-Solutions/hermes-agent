...
export const MODE_OPTIONS: ModeOption[] = [
  { id: 'light', label: 'Light', description: 'Use the light desktop palette.', icon: Sun },
  { id: 'dark', label: 'Dark', description: 'Use the dark desktop palette.', icon: Moon },
  { id: 'system', label: 'System', description: 'Follow the operating system appearance setting.', icon: Monitor }
]
