...
export const zhHant = defineLocale({
  ...
  updates: {
    ...
    miaInstallerTitle: 'M.i.A Hermes 更新已準備好',
    miaInstallerBody: '預備安裝程式已就緒。安裝時會顯示進度列，完成後 M.i.A Hermes 會自動重新開啟。',
    miaInstallerAction: '安裝更新',
    availableTitleBackend: '後端有可用更新',
    availableBodyBackend: '連線中的 Hermes 後端有新版本可供安裝。',
    availableBodyNoChangelog: '有新版本可用。此安裝類型無法顯示更新說明。',    updateNow: '立即更新',
    maybeLater: '稍後再說',
    ...
    applyingBody: '靜默安裝程式執行時，會顯示獨立的 Windows 進度視窗。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 Hermes 會自動重新連線。',
    applyingClose: 'M.i.A Hermes 關閉前，Windows 進度視窗會接管。',
    errorTitle: '更新未完成',
