...
export const en: Translations = {
  ...
  updates: {
    ...
    miaInstallerBody: 'A prepared installer is ready. Click update to close M.i.A Hermes and start the installer.',
    ...
    rollbackApplyingBody: 'M.i.A Hermes will close and reinstall the previous cached version.',
    applyingBodyBackend:
