...
export const en: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      rollbackUpdate: 'Voltar para versão anterior',
      rollbackUnavailable: 'Rollback unavailable',
      rollbackUnavailableMessage: 'No previous M.i.A Hermes installer is available on this machine.',
      ...
      rollbackHint: 'Rollback reinstalls the last cached M.i.A Hermes build if this update broke startup.',
  ...
  updates: {
    ...
    miaInstallerTitle: 'M.i.A Hermes update ready',
    miaInstallerBody: 'A prepared installer is ready. You’ll see a progress bar while it installs, then M.i.A Hermes reopens automatically.',
    miaInstallerAction: 'Install update',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Hermes backend is ready to install.',
    availableBodyNoChangelog: "A newer version is ready. Release notes are not available for this install type.",
    updateNow: 'Update now',
    rollbackAction: 'Voltar para versão anterior',
    ...
    applyingBody: 'A dedicated Windows progress window will stay visible while the silent installer runs.',
    rollbackApplyingBody: 'A dedicated Windows progress window will stay visible while M.i.A Hermes restores the previous cached version.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Hermes reconnects automatically when it’s back.',
    applyingClose: 'A Windows progress window will take over before M.i.A Hermes closes.',
    ...
    applyStatus: {
      ...
      rollbackPreparing: 'Preparing rollback…',
      rollingBack: 'Restoring previous version…',
      rollbackUnavailable: 'No previous M.i.A Hermes version is available to restore.',
      rollbackFailed: 'Rollback failed.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'M.i.A is loading a response',
      thinking: 'Thinking',
