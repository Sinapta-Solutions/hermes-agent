...
export const ja = defineLocale({
  ...
  updates: {
    ...
    miaInstallerBody: '準備済みインストーラーがあります。更新をクリックすると M.i.A Hermes を閉じてインストーラーを開始します。',
    ...
    availableBodyNoChangelog: '新しいバージョンを利用できます。このインストール形式ではリリースノートは表示できません。',    updateNow: '今すぐ更新',
    maybeLater: '後で',
