...
export const zh: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      retry: '重试',
      repairInstall: '修复安装',
      rollbackUpdate: '恢复到上一版本',
      rollbackUnavailable: '无法回滚',
      rollbackUnavailableMessage: '此机器上没有可用的上一版 M.i.A Hermes 安装器。',
      rollbackFailed: '回滚失败',
      useLocalGateway: '使用本地网关',
      openLogs: '打开日志',
      repairHint: '修复会重新运行安装器，在新机器上可能需要几分钟。',
      rollbackHint: '如果本次更新导致启动失败，回滚会重新安装最后缓存的 M.i.A Hermes 版本。',
  ...
  updates: {
    ...
    miaInstallerTitle: 'M.i.A Hermes 更新已准备好',
    miaInstallerBody: '预备安装程序已就绪。安装时会显示进度条，完成后 M.i.A Hermes 会自动重新打开。',
    miaInstallerAction: '安装更新',
    availableTitleBackend: '后端有可用更新',
    availableBodyBackend: '连接中的 Hermes 后端有新版本可供安装。',
    availableBodyNoChangelog: '有新版本可用。此安装类型无法显示更新说明。',
    updateNow: '立即更新',
    rollbackAction: '恢复到上一版本',
    maybeLater: '稍后再说',
    ...
    applyingBody: '静默安装程序运行时，会显示独立的 Windows 进度窗口。',
    rollbackApplyingBody: '恢复上一版缓存构建时，会显示独立的 Windows 进度窗口。',
    applyingBodyBackend: '远程后端正在应用更新并将重启。恢复后 Hermes 会自动重新连接。',
    applyingClose: 'M.i.A Hermes 关闭前，Windows 进度窗口会接管。',
    errorTitle: '更新未完成',
    ...
    applyStatus: {
      ...
      rollbackPreparing: '正在准备回滚…',
      rollingBack: '正在恢复上一版本…',
      rollbackUnavailable: '没有可恢复的上一版 M.i.A Hermes。',
      rollbackFailed: '回滚失败。',
